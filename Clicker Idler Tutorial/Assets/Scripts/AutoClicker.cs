...
public class AutoClicker : MonoBehaviour
{
    ...
    public delegate void AutoClickerDelegateDelegate(AutoClicker autoClickerScript);

    // declare a member variable of the type of the callback delegate
    public AutoClickerDelegateDelegate theDelegate = null;
