...
extern "C" UNITY_WRAPPER_LIBRARY_EXPORT void mesh_set_input_test_rectangle(stbvox_mesh_maker * mm, int width, int height, int depth, int size_world);
extern "C" UNITY_WRAPPER_LIBRARY_EXPORT void mesh_set_input_test_sphere(stbvox_mesh_maker * mm, int radius, int size_world);
extern "C" UNITY_WRAPPER_LIBRARY_EXPORT void mesh_set_buffer(stbvox_mesh_maker * mm, unsigned char* mesh_buffer, int mesh_buffer_length);
